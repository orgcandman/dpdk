...
#define AEU_INPUTS_ATTN_BITS_CCM_HW_INTERRUPT			 (0x1L << 31)
...
#define AEU_INPUTS_ATTN_BITS_MCP_LATCHED_SCPAD_PARITY		 (0x1L << 31)
...
#define AEU_INPUTS_ATTN_BITS_PBCLIENT_HW_INTERRUPT		 (0x1L << 31)
